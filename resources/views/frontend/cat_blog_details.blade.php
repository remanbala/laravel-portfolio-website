...
@section('title')
    Category Blog Details | Reman Bala Website
@endsection
                            ...
                            <ul class="rc__post">
                                ...
                                <li class="rc__post__item">
                                    <div class="rc__post__thumb">
                                        <a href="blog-details.html"><img src="{{ asset($singleBlog->blog_image) }}" alt=""></a>
                                    </div>
                                    <div class="rc__post__content">
                                        <h5 class="title"><a href="blog-details.html">{{ $singleBlog->blog_title }}</a></h5>
                                        <span class="post-date"><i class="fal fa-calendar-alt"></i> {{ Carbon\Carbon::parse($singleBlog->created_at)->diffForHumans() }}</span>
                                    </div>
                                </li>
                               @endforeach
                            </ul>
